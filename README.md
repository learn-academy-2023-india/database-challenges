...
- Branch name: `topic-initials1-initials2` (ex. associations-cb-sp)
- File name: `topic-name1-name2.sql` (ex. associations-charlean-sarah.md)
...
- $ `git checkout -b <topic-initials1-initials2>` (ex. associations-cb-sp)
